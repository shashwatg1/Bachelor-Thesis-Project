...
L=mydiscgaussfft(extend2(f,4,4),sxl2);  %extend2 adds padding and makes them equal to the boundary

Lx=crop2(filter2(dxmask,L,'same'),4,4)*sxl2^(1/2);  %crop2 removes a layers from all sides. Opposite of extend2
